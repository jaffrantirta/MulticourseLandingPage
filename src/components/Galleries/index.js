...
export default function Galleries({ limit }) {
    const galleries = [
        {
            img: ImgHero,
            alt: 'hero'
    ...
    return (
        <div className='h-fit font-primary p-10 bg-[url("/src/assets/images/bg-palm.png")] bg-cover bg-no-repeat'>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-1 mt-10">
                {galleries.slice(0, limit).map((item, index) => {
                    return (
                        <div key={index} className="aspect-square justify-center items-center flex hover:scale-110 transition-all duration-700">
